...
const STREAM_DATA_FRAME_SIZE: usize = 6;
const CHUNK_HEADER_SIZE: usize = 4;
const CRC_SIZE: usize = 4;
const MAX_COMPRESSED_SIZE: usize = 76490;

const MAX_DATA_FRAME_SIZE: usize = CHUNK_HEADER_SIZE + CRC_SIZE + MAX_COMPRESSED_SIZE;
const MAX_FRAME_SIZE: usize = STREAM_FRAME.len() + MAX_DATA_FRAME_SIZE;
